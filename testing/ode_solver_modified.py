...
# from odeint_modified import odeint
...
class ODESolver(Solver):
    ...
    def sample(
        ...
        **model_extras,
        ...
        sol_adjoint = torch.tensor([])
        sol_adjoint.require_grad = True
        ...
        if return_intermediates:
            return sol, sol_adjoint
        else:
            return sol[-1], sol_adjoint[-1]
